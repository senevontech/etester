            ...
            <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '2rem 1rem' }}>
                <div className="anim-fade-up" style={{ width: '100%', maxWidth: '400px' }}>
                    ...
                    <div style={{ marginBottom: '1.75rem' }}>
                        <h1 className="t-h1" style={{ marginBottom: '0.375rem' }}>Create student account</h1>
                        <p className="t-body">Admin accounts are created only by super admin. This signup form is for students.</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '0.875rem' }}>
                        ...
                        <button type="submit" className="btn btn-lg btn-primary hover-glow" style={{ width: '100%', marginTop: '0.25rem', gap: '0.5rem' }} disabled={loading}>
                            {loading
                                ...
                                : <><span>Create Student Account</span><ArrowRight size={16} /></>}
                        </button>
                    </form>
