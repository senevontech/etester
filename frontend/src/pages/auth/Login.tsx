...
import { Shield, Eye, EyeOff, ArrowRight, Moon, Sun, Loader2, House } from 'lucide-react';
...
const Login: React.FC = () => {
    ...
    }, [activeOrg, authLoading, canUseOrgSetup, from, isAuthenticated, navigate, orgLoading, user?.role]);
